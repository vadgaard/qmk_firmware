...
[_LOWER] = LAYOUT_split_3x6_3_ex2(
    ...
    KC_CAPS, _______, _______, KC_PGUP, KC_PGDN, _______, _______, _______, KC_HOME, KC_LPRN, KC_RPRN, KC_MINS, KC_EQL,  KC_BSLS,
...
[_RAISE] = LAYOUT_split_3x6_3_ex2(
    ...
    KC_CAPS, KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC, _______, _______, KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, _______,
...
[_ADJUST] = LAYOUT_split_3x6_3_ex2(
    ...
    RM_TOGG, RM_HUEU, RM_SATU, RM_VALU, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
